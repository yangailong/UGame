...
{
    public const string DllPath = "AddressableAssets/Remote/Dll/HotFixAssembly.dll";

    public const string PDBPath = "AddressableAssets/Remote/Dll/HotFixAssembly.pdb";
